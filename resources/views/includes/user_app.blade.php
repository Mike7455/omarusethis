...
<head>
	<title>StudyMate - @yield('page_name')</title>
		...
		<div class="container">
			...
			<div class="navbar-collapse w-100 collapse" id="navbarCollapse">
				...
				<ul class="navbar-nav navbar-nav-scroll me-auto">
                    ...
                    @if (auth()->user()->role=='0')
                        <li class="nav-item">
                            <a class="nav-link" href="/mate" aria-haspopup="true" aria-expanded="false">Find Mate</a>
...
{{--
			...
			<div class="dropdown ms-1 ms-lg-0">
				...
				<ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
					...
					<li><a class="dropdown-item" href="/chatify"><i class="bi bi-info-circle fa-fw me-2"></i>Chat</a></li>
					<li><form action="{{ route('sign_out')}}" method="POST">@csrf<button class="dropdown-item bg-danger-soft-hover"><i class="bi bi-power fa-fw me-2"></i>Sign Out</button></form></li>
					<li> <hr class="dropdown-divider"></li>
			...
			<div class="col-lg-6">
				<div class="row g-4">
                    ...
                    <div class="col-6 col-md-4">
                        ...
                        <p class="mb-0">Email:<span class="h6 fw-light ms-2">CsStudymate@gmail.com</span></p>
