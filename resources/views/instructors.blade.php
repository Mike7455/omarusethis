    ...
    <section class="pt-4">
        <div class="container">
            ...
            <div class="row mb-4 align-items-center">
                ...
                <div class="col-sm-6 col-xl-3 mt-0 mt-xl-0"></div>
                <!-- Select option -->
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <div class="d-sm-flex justify-content-sm-between mb-2 mb-sm-3">
                                        <div>
                                            <h5 class="card-title mb-0"><a href="/instructor-detail/{{$instructor->id}}">{{$instructor->fname." ".$instructor->lname}}</a></h5>
                                            <p class="small mb-2 mb-sm-0">{{$instructor->institution}}</p>
                                        </div>
                                        {{-- <span class="h6 fw-light">4.3<i class="fas fa-star text-warning ms-1"></i></span> --}}
                                    </div>
                                    <!-- Content -->
                                    <p class="text-truncate-2 mb-3">{{ $instructor->description }}</p>
                                    <!-- Info -->
                                    <div class="d-sm-flex justify-content-sm-between align-items-center">
                                        <!-- Title -->
                                        <h6 class="text-orange mb-0">{{ $instructor->study_field }}</h6>
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <div class="d-sm-flex justify-content-sm-between mb-2 mb-sm-3">
                                        <div>
                                            <h5 class="card-title mb-0"><a href="/instructor-detail">Dennis Barrett</a></h5>
                ...
                <div class="row justify-content-center position-relative">
                    ...
                    <div class="col-11 position-relative">
                        <div class="row align-items-center">
                            <!-- Title -->
                            <div class="col-lg-7">
                                <h3 class="text-white"> Instructor Help!</h3>
                                <p class="text-white mb-3 mb-lg-0">Assisting learning and providing accurate and timely information about various topics being discussed by students.</p>
                            </div>
                            <!-- Button -->
                            <div class="col-lg-5 text-lg-end">
                                <a href="#" class="btn btn-dark mb-0">Be an instructor today</a> <!--take to instructor sing up-->
                            </div>
                        </div>
                    </div>
                </div>
