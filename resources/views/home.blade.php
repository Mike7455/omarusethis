	...
	<div class="container">
		...
		<div class="row align-items-center g-5">
			...
			<div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
				...
				<!-- Title -->
				<h1 class="mb-0 display-6">Conntect with Study mates and
					<span class="position-relative">Learn
						<!-- SVG START -->
						<span class="position-absolute top-50 start-50 translate-middle ms-3 z-index-n1">
							<svg width="200px" height="62.1px" enable-background="new 0 0 366 62.1" viewBox="0 0 366 62.1" xmlns="http://www.w3.org/2000/svg">
				...
				<!-- Content -->
				<p class="my-4 lead">Computer Science Studymate is a web application which serves as a social networking platform for all computer science students across the country to share ideas and experiences.....</p>
		...
		<div class="row g-4">
			...
			<div class="col-sm-6 col-xl-3">
				<div class="d-flex justify-content-center align-items-center p-4 bg-warning bg-opacity-15 rounded-3">
					...
					<div class="ms-4 h6 fw-normal mb-0">
						<div class="d-flex">
							<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="{{$courses}}"	data-purecounter-delay="200">0</h5>
			...
			<div class="col-sm-6 col-xl-3">
				<div class="d-flex justify-content-center align-items-center p-4 bg-blue bg-opacity-10 rounded-3">
					...
					<div class="ms-4 h6 fw-normal mb-0">
						<div class="d-flex">
							<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="{{ $students }}" data-purecounter-delay="200">0</h5>
							<span class="mb-0 h5"></span>
						</div>
                        @if (auth()->user()->role=='2')
                            <p class="mb-0">Students</p>
                        @else
                            <p class="mb-0">Mates</p>
                        @endif
			...
			<div class="col-sm-6 col-xl-3">
				<div class="d-flex justify-content-center align-items-center p-4 bg-purple bg-opacity-10 rounded-3">
					...
					<div class="ms-4 h6 fw-normal mb-0">
						<div class="d-flex">
							<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="{{ $instructors }}"	data-purecounter-delay="200">0</h5>
							<span class="mb-0 h5"></span>
						</div>
			...
			<div class="col-sm-6 col-xl-3">
				<div class="d-flex justify-content-center align-items-center p-4 bg-info bg-opacity-10 rounded-3">
					<span class="display-6 lh-1 text-info mb-0"><i class="bi bi-book"></i></span>
					<div class="ms-4 h6 fw-normal mb-0">
						<div class="d-flex">
							<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="{{ $books }}" data-purecounter-delay="300">0</h5>
							<span class="mb-0 h5"></span>
						</div>
	...
	<div class="container">
		...
		<div class="row mb-4">
			<div class="col-lg-8 mx-auto text-center">
				...
				<p class="mb-0">Connect with lecturers on each course</p>
			</div>
		</div>
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							...
							<div class="card-body pb-0">
								...
								<!-- Title -->
								<h5 class="card-title fw-normal"><a href="/courses">Computer Security</a></h5>
								<p class="mb-2 text-truncate-2">Computer security is the protection that is set up for computer systems and keeps critical information from unauthorized access, theft, or misuse.</p>
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							...
							<div class="card-body pb-0">
								...
								<!-- Title -->
								<h5 class="card-title fw-normal"><a href="/courses">Web Develpoment</a></h5>
								<p class="mb-2 text-truncate-2">Web development is the building and maintenance of websites; it's the work that happens behind the scenes to make a website look great.</p>
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							...
							<div class="card-body pb-0">
								...
								<!-- Title -->
								<h5 class="card-title fw-normal"><a href="/courses">Data Communication</a></h5>
								<p class="mb-2 text-truncate-2">Data communication refers to the exchange of data between a source and a receiver via form of transmission media such as a wire cable.</p>
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							...
							<div class="card-body pb-0">
								...
								<!-- Title -->
								<h5 class="card-title fw-normal"><a href="/courses">Computer Networks</a></h5>
								<p class="mb-2 text-truncate-2">Computer networking refers to interconnected computing devices that can exchange data and share resources with each other.</p>
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							...
							<div class="card-body pb-0">
								...
								<!-- Title -->
								<h5 class="card-title fw-normal"><a href="/courses">Java Programming</a></h5>
								<p class="mb-2 text-truncate-2"> Java is a general-purpose, class-based, object-oriented programming language designed for having lesser implementation dependencies.</p>
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							...
							<div class="card-body pb-0">
								...
								<!-- Title -->
								<h5 class="card-title fw-normal"><a href="/courses">Software Engineering</a></h5>
								<p class="mb-2 text-truncate-2">Software engineering is the application of principles used in the field of engineering, which usually deals with physical systems, to the design, development, testing, deployment and management of software systems.</p>
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							...
							<div class="card-body pb-0">
								...
								<!-- Title -->
								<h5 class="card-title fw-normal"><a href="/courses">E-Commerce</a></h5>
								<p class="mb-2 text-truncate-2">E-commerce (electronic commerce) is the buying and selling of goods and services, or the transmitting of funds or data, over an electronic network, primarily the internet.</p>
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							...
							<div class="card-body pb-0">
								...
								<!-- Title -->
								<h5 class="card-title fw-normal"><a href="/courses">Artificial Intelligence</a></h5>
								<p class="mb-2 text-truncate-2">Artificial intelligence is based on the principle that human intelligence can be defined in a way that a machine can easily mimic it and execute tasks, from the most simple to those that are even more complex.</p>
					...
					<div class="row position-relative">
						...
						<div class="col-11 mx-auto position-relative">
							<div class="row align-items-center">
								<!-- Title -->
								<div class="col-lg-7">
									<h3 class="text-white">Study Mate</h3>
									<p class="text-white mb-3 mb-lg-0">Connect with your colleague from afar and study</p>
								</div>
								<!-- Content and input -->
