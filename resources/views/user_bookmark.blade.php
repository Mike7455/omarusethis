				...
				<ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
					...
					<li class="px-3 mb-3">
						<div class="d-flex align-items-center">
							...
							<div>
								<a class="h6" href="/user-dashboard">Lori Ferguson</a>
					...
					<!-- Links -->
					<li><a class="dropdown-item" href="/user-edit"><i class="bi bi-person fa-fw me-2"></i>Edit Profile</a></li>
					<li><a class="dropdown-item" href="/user-setting"><i class="bi bi-gear fa-fw me-2"></i>Account Settings</a></li>
					<li><a class="dropdown-item" href="user-help"><i class="bi bi-info-circle fa-fw me-2"></i>Help</a></li>
					<li><a class="dropdown-item bg-danger-soft-hover" href="/user-sign-out"><i class="bi bi-power fa-fw me-2"></i>Sign Out</a></li>
					<li> <hr class="dropdown-divider"></li>
                        ...
                        <div class="offcanvas-body p-3 p-xl-0">
                            <div class="bg-dark border rounded-3 pb-0 p-3 w-100">
                                ...
                                <div class="list-group list-group-dark list-group-borderless">
                                    ...
                                    <a class="list-group-item active" href="/user-bookmark"><i class="bi bi-cart-check fa-fw me-2"></i>Wishlist</a>
                                    <a class="list-group-item" href="/user-edit-profile"><i class="bi bi-pencil-square fa-fw me-2"></i>Edit Profile</a>
                                    ...
                                    <div class="card shadow h-100">
                                        ...
                                        <div class="card-footer pt-0 pb-3">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <span class="h6 fw-light mb-0"><i class="fas fa-solid fa-user-graduate text-orange me-2"></i>65 lectures</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
