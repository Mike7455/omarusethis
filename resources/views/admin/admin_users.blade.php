	...
	<div class="offcanvas offcanvas-start flex-row custom-scrollbar h-100" data-bs-backdrop="true" tabindex="-1" id="offcanvasSidebar">
		<div class="offcanvas-body sidebar-content d-flex flex-column bg-dark">
			...
			<ul class="navbar-nav flex-column" id="navbar-sidebar">
				...
				<!-- Menu item 3 -->
				<li class="nav-item"> <a class="nav-link active" href="/admin-users"><i class="fas fa-user-graduate fa-fw me-2"></i>Students</a></li>
							...
							<table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center position-relative">
												...
												<div class="mb-0 ms-3">
													<!-- Title -->
													<h6 class="mb-0"><a href="admin-user-detail/{{ $user->id }}" class="stretched-link">{{$user->fname." ".$user->lname}}</a></h6>
													<span class="text-body small"><i class="fas fa-fw fa-map-marker-alt me-1 mt-1"></i>{{$user->institution}}<span>
												</div>
											</div>
										</td>
										...
										<!-- Table data -->
										<td>
											<a href="/admin-user-detail/{{$user->id}}" class="btn btn-light btn-round me-1 mb-1 mb-md-0" data-bs-toggle="tooltip" data-bs-placement="top" title="View">
												<i class="bi bi-eye"></i>
											</a>
											<a href="/user/chat" class="btn btn-light btn-round me-1 mb-1 mb-md-0" data-bs-toggle="tooltip" data-bs-placement="top" title="Message">
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center position-relative">
												...
												<div class="mb-0 ms-3">
													...
													<span class="text-body small"><i class="fas fa-fw fa-map-marker-alt me-1 mt-1"></i>Institution<span>
												</div>
											</div>
										</td>
										...
										<!-- Table data -->
										<td>
											<a href="/admin-user-detill" class="btn btn-light btn-round me-1 mb-1 mb-md-0" data-bs-toggle="tooltip" data-bs-placement="top" title="View">
												<i class="bi bi-eye"></i>
											</a>
											<a href="/user/chat" class="btn btn-light btn-round me-1 mb-1 mb-md-0" data-bs-toggle="tooltip" data-bs-placement="top" title="Message">
												<i class="bi bi-envelope"></i>
