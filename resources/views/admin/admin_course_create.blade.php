	...
	<div class="page-content-wrapper border">
		...
		<div class="row">
			<div class="col-12 mb-3">
				<h1 class="h3 mb-2 mb-sm-0">Submit a new Course</h1>
			</div>
		</div>

        <div class="card bg-transparent border rounded-3 mb-0">
			<div class="card-header bg-light border-bottom">
            </div>
            <div class="card-body">
                <form action="{{ route('admin_new_course') }}" method="POST" >
                    @csrf
                    ...
                    {{-- <div class="content fade"> --}}
                        ...
                        {{-- <div class="row g-6"> --}}
                            ...
                            <div class="col-12">
                                ...
                                <input name="course_title" class="form-control" type="text" placeholder="Enter course title">
                            </div>
                            <br>
                            <!-- Short description -->
                            <div class="col-12">
                                <label class="form-label">Short description</label>
                                <textarea name="course_description" class="form-control" rows="2" placeholder="Enter keywords"></textarea>
                            </div>
										...
										<div class="text-center justify-content-center align-items-center p-4 p-sm-5 border border-2 border-dashed position-relative rounded-3">
											...
											<div>
												...
												<label style="cursor:pointer;">
													<span> 
														<input name="pic" class="form-control stretched-link" type="file" name="my-image" id="image" accept="image/gif, image/jpeg, image/png" />
													</span>
												</label>
                            ...
                            <div class="d-flex justify-content-end mt-3">
                                <button class="btn btn-primary next-btn mb-0" type="submit">Submit</button>
                            </div>
                        </div>
                        <!-- Basic information START -->
                    </div>
