	...
	<div class="page-content-wrapper border">
		...
		<div class="row">
			<div class="col-12 mb-3">
				<h1 class="h3 mb-2 mb-sm-0">Add a New Book</h1>
			</div>
		</div>
        ...
        <div class="card bg-transparent border rounded-3 mb-0">
            ...
            <div class="card-body">
                <form action="{{ route('admin_new_book') }}" method="POST">
                    @csrf
                    ...
                    {{-- <div class="content fade"> --}}
                        ...
                        {{-- <div class="row g-6"> --}}
                            ...
                            <div class="col-12">
                                ...
                                <input name="book_title" class="form-control" type="text" placeholder="Enter course title">
                            </div>
                            <br>
                            <!-- Short description -->
                            <div class="col-12">
                                <label class="form-label">Author</label>
                                <textarea  name="author" class="form-control" rows="2" placeholder="Enter keywords"></textarea>
                            </div>
