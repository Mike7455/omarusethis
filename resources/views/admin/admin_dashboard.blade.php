			...
			<div class="px-3 mt-auto pt-3">
				<div class="d-flex align-items-center justify-content-between text-primary-hover">
                        ...
                        <form action="{{route('sign_out')}}" method="POST">
                            @csrf
						    <button class="h5 mb-0 text-body" data-bs-toggle="tooltip" data-bs-placement="top" title="Sign out">
		...
		<div class="container-fluid p-0">
			<div class="d-flex align-items-center w-100">
                ...
                <li> <hr class="dropdown-divider"></li>
								...
								<li><form action="{{ route('sign_out_admin')}}" method="POST">@csrf<button class="dropdown-item bg-danger-soft-hover"><i class="bi bi-power fa-fw me-2"></i>Sign Out</button></form></li>
			...
			<div class="col-lg-6 col-xxl-6">
				<div class="card card-body bg-warning bg-opacity-15 p-4 h-100">
					<div class="d-flex justify-content-between align-items-center">
						<!-- Digit -->
						<div>
							<h2 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="{{$students}}" data-purecounter-delay="5">0</h2>
			...
			<div class="col-lg-6 col-xxl-6">
				<div class="card card-body bg-purple bg-opacity-10 p-4 h-100">
					<div class="d-flex justify-content-between align-items-center">
						<!-- Digit -->
						<div>
							<h2 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="{{$instructors}}"	data-purecounter-delay="5">0</h2>
			...
			<div class="col-lg-6 col-xxl-6">
				<div class="card card-body bg-primary bg-opacity-10 p-4 h-100">
					<div class="d-flex justify-content-between align-items-center">
						<!-- Digit -->
						<div>
							<h2 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="{{$courses}}"	data-purecounter-delay="200">5</h2>
			...
			<div class="col-lg-6 col-xxl-6">
				<div class="card card-body bg-success bg-opacity-10 p-4 h-100">
					<div class="d-flex justify-content-between align-items-center">
						...
						<div>
							<div class="d-flex">
								<h2 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="{{$books}}"	data-purecounter-delay="5">0</h2>
								{{-- <span class="mb-0 h2 ms-1">hrs</span> --}}
							</div>
							<span class="mb-0 h6 fw-light">EBooks</span>
						</div>
						<!-- Icon -->
