...
<!-- Mirrored from offsetcode.com/themes/messenger/2.2.0/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 Aug 2022 11:12:00 GMT -->
<head>
        <meta charset="UTF-8">
        ...
        <!-- Favicon -->
        <link rel="shortcut icon" href="{{asset('assets/chat/assets/img/favicon/favicon.ico')}}" type="image/x-icon">
        ...
        <!-- Template CSS -->
        <link class="css-lt" rel="stylesheet" href="{{asset('assets/chat/assets/css/template.bundle.css')}}" media="(prefers-color-scheme: light)">
        <link class="css-dk" rel="stylesheet" href="{{asset('assets/chat/assets/css/template.dark.bundle.css')}}" media="(prefers-color-scheme: dark)">
    ...
    <body>
                    ...
                    <li class="nav-item d-none d-xl-block">
                        <a href="#" class="nav-link p-0 mt-lg-2" data-bs-toggle="modal" data-bs-target="#modal-profile">
                            <div class="avatar avatar-online mx-auto">
                                <img class="avatar-img" src="{{asset('assets/chat/assets/img/avatars/1.jpg')}}" alt="">
                            </div>
                        </a>
                    </li>
                </ul>
                                                        ...
                                                        <div class="row align-items-center gx-5">
                                                            <div class="col-auto">
                                                                <div class="avatar ">
                                                                        ...
                                                                        <img class="avatar-img" src="{{asset('assets/chat/assets/img/avatars/6.jpg')}}" alt="">
                                                        ...
                                                        <div class="row align-items-center gx-5">
                                                            <div class="col-auto">
                                                                <div class="avatar ">
                                                                        ...
                                                                        <img class="avatar-img" src="{{asset('assets/chat/assets/img/avatars/5.jpg')}}" alt="">
                                                        ...
                                                        <div class="row align-items-center gx-5">
                                                            <div class="col-auto">
                                                                <div class="avatar avatar-online">
                                                                        ...
                                                                        <img class="avatar-img" src="{{asset('assets/chat/assets/img/avatars/8.jpg')}}" alt="">
                                                        ...
                                                        <div class="row align-items-center gx-5">
                                                            <div class="col-auto">
                                                                <div class="avatar ">
                                                                        ...
                                                                        <img class="avatar-img" src="{{asset('assets/chat/assets/img/avatars/11.jpg')}}" alt="">
                                                        ...
                                                        <div class="row align-items-center gx-5">
                                                            <div class="col-auto">
                                                                <div class="avatar ">
                                                                        ...
                                                                        <img class="avatar-img" src="{{asset('assets/chat/assets/img/avatars/4.jpg')}}" alt="">
                                                        ...
                                                        <div class="row align-items-center gx-5">
                                                            <div class="col-auto">
                                                                <div class="avatar avatar-online">
                                                                        ...
                                                                        <img class="avatar-img" src="{{asset('assets/chat/assets/img/avatars/7.jpg')}}" alt="">
                                        ...
                                        <a href="chat-group.html" class="card border-0 text-reset">
                                            <div class="card-body">
                                                <div class="row gx-5">
                                                    <div class="col-auto">
                                                        <div class="avatar avatar-online">
                                                            <img src="{{asset('assets/chat/assets/img/avatars/7.jpg')}}" alt="#" class="avatar-img">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row align-items-center gx-4">
                                                    <div class="col-auto">
                                                        <div class="avatar avatar-xs">
                                                            <img class="avatar-img" src="{{asset('assets/chat/assets/img/avatars/bootstrap.svg')}}" alt="Bootstrap Community">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-auto">
                                                        <div class="avatar-group">
                                                            <div class="avatar avatar-xs">
                                                                <img src="{{asset('assets/chat/assets/img/avatars/12.jpg')}}" alt="#" class="avatar-img">
                                                            </div>

                                                            <div class="avatar avatar-xs">
                                                                <img src="{{asset('assets/chat/assets/img/avatars/11.jpg')}}" alt="#" class="avatar-img">
                                                            </div>

                                                            <div class="avatar avatar-xs">
                                                                <img src="{{asset('assets/chat/assets/img/avatars/9.jpg')}}" alt="#" class="avatar-img">
                                                            </div>
                                        ...
                                        <a href="chat-direct.html" class="card border-0 text-reset">
                                            <div class="card-body">
                                                <div class="row gx-5">
                                                    <div class="col-auto">
                                                        <div class="avatar avatar-online">
                                                            <img src="{{asset('assets/chat/assets/img/avatars/6.jpg')}}" alt="#" class="avatar-img">
                                                        </div>
                                                    </div>
                                        ...
                                        <a href="chat-empty.html" class="card border-0 text-reset">
                                            <div class="card-body">
                                                <div class="row gx-5">
                                                    <div class="col-auto">
                                                        <div class="avatar avatar-online">
                                                            <img src="{{asset('assets/chat/assets/img/avatars/8.jpg')}}" alt="#" class="avatar-img">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row gx-5">
                                                    <div class="col-auto">
                                                        <div class="avatar-group-trigon avatar-group-trigon-sm">
                                                            ...
                                                            <div class="avatar avatar-sm">
                                                                <img class="avatar-img" src="{{asset('assets/chat/assets/img/avatars/9.jpg')}}" alt="#">
                                                            </div>
                                        ...
                                        <a href="chat-direct.html" class="card border-0 text-reset">
                                            <div class="card-body">
                                                <div class="row gx-5">
                                                    <div class="col-auto">
                                                        <div class="avatar">
                                                            <img src="{{asset('assets/chat/assets/img/avatars/4.jpg')}}" alt="#" class="avatar-img">
                                                        </div>
                                                    </div>
                                        ...
                                        <a href="chat-direct.html" class="card border-0 text-reset">
                                            <div class="card-body">
                                                <div class="row gx-5">
                                                    <div class="col-auto">
                                                        <div class="avatar avatar-online">
                                                            <img src="{{asset('assets/chat/assets/img/avatars/5.jpg')}}" alt="#" class="avatar-img">
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="card border-0">
                                        <div class="card-body">
                                            <div class="row align-items-center gx-5">
                                                <div class="col-auto">
                                                    <div class="avatar">
                                                        <img src="{{asset('assets/chat/assets/img/avatars/1.jpg')}}" alt="#" class="avatar-img">
        ...
        <!-- Scripts -->
        <script src="{{asset('assets/chat/assets/js/vendor.js')}}"></script>
        <script src="{{asset('assets/chat/assets/js/template.js')}}"></script>
    </body>
