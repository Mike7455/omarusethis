...
<!-- Mirrored from eduport.webestica.com/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 Aug 2022 00:46:44 GMT -->
<head>
				...
				<div class="col-12 col-lg-6 m-auto">
					<div class="row my-5">
						<div class="col-sm-10 col-xl-8 m-auto">
							...
							<h1 class="fs-2">Login into CS Study Mate!</h1>
							...
							<form action="/sign_in" method="POST">
								...
								<div class="mb-4 d-flex justify-content-between mb-4">
									...
									<div class="text-primary-hover">
										<a href="/forgot_password" class="text-secondary">
											<u>Forgot password?</u>
										</a>
									</div>
								</div>
							...
							<div class="mt-4 text-center">
								<span>Don't have an account? <a href="/sign_up">Signup here</a></span>
							</div>
						</div>
					</div> <!-- Row END -->
				</div>
...
<!-- Mirrored from eduport.webestica.com/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 Aug 2022 00:46:45 GMT -->
</html>