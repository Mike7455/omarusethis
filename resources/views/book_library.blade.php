                ...
                <div class="bg-light p-4 rounded-3 position-relative overflow-hidden">
                    ...
                    <div class="row position-relative align-items-center">
                        ...
                        <div class="col-md-6 px-md-5">
                            <!-- Title -->
                            <h1 class="mb-3">Welcome to our Book library!</h1>
                            <p class="mb-3">Expand your knowledge by reading books relating to Computer Science. </p>
                                ...
                                <div class="card shadow h-100">
                                    ...
                                    <div class="card-body px-3">
                                        ...
                                        <h5 class="card-title mb-0">
                                            <a href="shop-product-detail.html" class="stretched-link">{{$book->book_name}}</a>
                                        </h5>
                                    </div>
                                    ...
                                    <div class="card-footer pt-0 px-3">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <span class="h6 fw-light mb-0">By {{$book->author}}</span>
                                            <!-- Price -->
                ...
                <div class="col-lg-6">
                    <div class="bg-warning rounded-3 bg-opacity-15 p-5 h-100">
                        ...
                        <div class="row g-3 align-items-center my-auto">
                            <!-- Content -->
                            <div class="col-sm-7 col-lg-12 col-xl-7">
                                <h2 class="mb-1 fs-1">Study Mate Books</h2>
                                <p class="mb-3 h5 fw-light lead">Enjoy the computer science program with the best-rated Books.</p>
